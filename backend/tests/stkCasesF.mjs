...
C("STK-33.2", T33, "With no row at all, the BOM endpoint still answers.", 20, {
...
C("STK-33.3", T33, "Put the row back before anything else runs.", 20, {
  ...A,
...
C("STK-34.1", T34, "Withdraw ORG-A's Inventory subscription.", 20, {
  ...A,
...
C("STK-34.2", T34, "The stock ledger is refused, with a status somebody can act on.", 20, {
...
C("STK-34.3", T34, "So are adjustments, transfers and valuation.", 20, {
...
C("STK-34.4", T34, "The BOOKS are untouched. This is the half that matters.", 20, {
...
C("STK-34.5", T34, "It can still buy, sell and file.", 20, {
...
C("STK-34.6", T34, "The item master stays open, because SERVICE items live there.", 20, {
...
C("STK-34.7", T34, "A SERVICE item can still be created; a STOCK item cannot.", 20, {
...
C("STK-34.8", T34, "The service half of that same pair.", 20, {
...
C("STK-35.1", T35, "Reinstate the subscription.", 20, {
  ...A,
...
C("STK-35.2", T35, "And the stock ledger answers again.", 20, {
...
C("STK-35.3", T35, "Nothing else was changed on the way through.", 20, {
  ...A,
