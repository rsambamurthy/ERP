...
export interface PurchaseOrderPdfData {
  ...
  taxTotal: number;
  grandTotal: number;
  // Foreign-currency POs only — see the schema.prisma comment on
  // PurchaseOrder.currency. currency stays "INR" / exchangeRate stays 1 /
  // grandTotalFc stays null for every domestic PO, unchanged from before
