...
Write-Host 'Asset classes endpoint...' -ForegroundColor Cyan
...
Set-FileText 'backend/src/routes/assetClasses.ts' 'import { Router } from "express";
...
Write-Host 'Next: cd backend; npx.cmd tsc --noEmit'