// Inline SVGs for the Register accordion's icon chips. stroke="currentColor"
// so each one inherits its color from .acc-step-icon (locked/active/complete
// states are set via CSS, not per-icon props).
