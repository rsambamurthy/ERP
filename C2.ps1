...
Write-Host 'Stock transfers: the screen...' -ForegroundColor Cyan
...
Edit-FileText 'frontend/lib/types.ts' '  notes: string | null;
...
Edit-FileText 'frontend/lib/api.ts' '  DepreciationReverseResult,
  BillOfMaterials,
...
Edit-FileText 'frontend/lib/api.ts' '  return request<{ data: { writtenOff: number; cancelled: boolean } }>(
...
Edit-FileText 'frontend/components/layout/navGroups.ts' '    label: "Inventory",
    icon: "I",
    items: [
...
Set-FileText 'frontend/app/inventory/stock-transfers/page.tsx' '"use client";
