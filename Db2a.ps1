...
Write-Host 'Phase D-b part 2a: migration_045, the third journal entry column...' -ForegroundColor Cyan
...
'@
Set-FileText 'db/migration_045_transfer_transit_clearing.sql' $f0
Write-Host ''
